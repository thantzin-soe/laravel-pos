...
<h3>Products</h3>
  ...
  <table width="100%">
    ...
    @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
            <img src="{{ $item->product->image_url }}" height="50px;" width="50px;" alt="">
        </td>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span> {{ $order->total }} ks</h2>
            <h2><span style="color: green;">Total:</span> {{ $order->total }} ks</h2>
